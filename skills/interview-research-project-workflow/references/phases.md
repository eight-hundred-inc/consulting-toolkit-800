...
- 初期仮説が完備な文章で記載されているか
- 見積りが複数プランで提示されているか
- CLAUDE.md の論点サマリ・仮説ステータス・アプローチが提案書と同期されているか
...
- CLAUDE.md の論点サマリ・仮説ステータス・アプローチが提案書の更新内容と同期されているか
...
- インタビュー結果から新たな論点・仮説の変化が生じていないか確認し、CLAUDE.md の同期が必要な変化がないか確認
...
- 仮説検証シートが更新されている
- CLAUDE.md の仮説ステータスが調査結果と同期されているか確認
