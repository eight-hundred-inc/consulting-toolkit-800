...
```powershell
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/masaki69/consulting-toolkit/main/install.ps1" -OutFile "$env:TEMP\install.ps1"; powershell -ExecutionPolicy Bypass -File "$env:TEMP\install.ps1"
```
