...
| 第 2 層 レイアウトパターン | `slide-pattern-creator` / `library` | スライドの中身をどう並べるか（136 種のパターン）。**レイアウトの正本はここ** |
...
- **レイアウトの正本は第 2 層（レイアウトパターン）**。html-artifact が持つコンポーネントや図解は「スライド 1 枚の中の部品や図の作り方」であって、スライド全体の並べ方は決めない。
